...
import FloatActions from './FloatActions.js';
...
export default defineComponent({
  name: 'AppShell',
  components: {
    Sidebar, FloatActions, WelcomeView, ChatView, StatsView,
    ContactModal, SkillsModal, NoticeModal
  },
  setup() {
    ...
    return {
      viewState, isWelcome, isChat, isStats,
      contactOpen, skillsOpen, noticeOpen, noticeFeature,
      openContact, openSkills, openNotice, onNoticeContact,
      onNewChat, onSubmit
    };
  },
  template: `
